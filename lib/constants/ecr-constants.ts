...
export const PS_REPLAY_EXTRACTION_LAMBDA_ECR_PROD_TAG = "2d7abb2";
export const PS_REPLAY_EXTRACTION_LAMBDA_ECR_DEV_TAG = "2d7abb2";
...
export const PS_REPLAY_TRANSFORM_LAMBDA_ECR_DEV_TAG = "ae68f7d";
...
export const PS_TEAMS_DDB_WRITER_LAMBDA_ECR_DEV_TAG = "9478bad";
